	...
	populateSimpleForm = function (data, form, prefix) {
	    ...
	    for (key in data) {
	        if (data.hasOwnProperty(key)) {
	            ...
	            } else if (Array.isArray(data[key]) && Object.prototype.toString.call(data[key][0]) === '[object Object]') {
	            	populateSimpleForm(data[key], form, prefix + key + '_');
	            } else if (Array.isArray(data[key]) && //check if this is a multi field list rather than one that needs to be joined into a single pipe separated value
